...
router
  .route("/additional-data-of-shipper")
  .get(loadController.getAdditionalDataShipper);
...
router.route("/loading-view").get(loadController.LoadingView);
router.route("/uloading-view").get(loadController.ULoadingView);
...
router.route("/load-details/:id").get(loadController.getLoadDetails);
router
  .route("/:code")
